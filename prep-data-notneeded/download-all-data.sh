...
#only run if not running the other download files in parallel
...
rm coco_annotations_minival.tgz train2017.zip val2017.zip test2017.zip annotations_trainval2017.zip image_info_test2017.zip
